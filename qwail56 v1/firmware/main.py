...
keyboard.keymap = [
    ...
    KC.LCTRL,  KC.A,   KC.S,   KC.D,    KC.F,    KC.G,     KC.NO,      KC.NO,   KC.H,     KC.J,    KC.K,    KC.L,   KC.SCLN, KC.QUOT,
    KC.LSHIFT, KC.Z,   KC.X,   KC.C,    KC.V,    KC.B,     KC.MPLY,    KC.MPLY, KC.N,     KC.M,    KC.COMM, KC.DOT, KC.SLSH, KC.RSFT,
    KC.NO,     KC.NO,  KC.NO,  KC.LGUI, KC.LALT, KC.MO(1), KC.SPC,     KC.ENT,  KC.MO(2), KC.RALT, KC.RCTL, KC.NO,  KC.NO,   KC.NO,
    ],
    ...
    KC.LCTRL,  KC.DEL, KC.END,  KC.PGDN, KC.NO,   KC.NO,   KC.NO,      KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.UP,   KC.NO,   KC.NO,
    KC.LSHIFT, KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.MPLY,    KC.MPLY, KC.NO,   KC.NO,   KC.LEFT, KC.DOWN, KC.RGHT, KC.RSFT,
    KC.NO,     KC.NO,  KC.NO,   KC.LGUI, KC.LALT, KC.TRNS, KC.SPC,     KC.ENT,  KC.TRNS, KC.RALT, KC.RCTL, KC.NO,   KC.NO,   KC.NO,
    ],

    # symbol layer
    [
    KC.ESC,    KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,    KC.NO,      KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.GRV,  KC.PLUS, KC.BSPC,
    KC.TAB,    KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,    KC.NO,      KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.LBRC, KC.RBRC, KC.BSLS,
    KC.LCTRL,  KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,    KC.NO,      KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.SCLN, KC.ENT,
    KC.LSHIFT, KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,    KC.MPLY,    KC.MPLY, KC.NO,   KC.NO,   KC.COMM, KC.DOT,  KC.MINS, KC.RSFT,
    KC.NO,     KC.NO,  KC.NO,  KC.LGUI, KC.LALT, KC.TRNS,  KC.SPC,     KC.ENT,  KC.TRNS, KC.RALT, KC.RCTL, KC.NO,   KC.NO,   KC.NO,
    ],
]
